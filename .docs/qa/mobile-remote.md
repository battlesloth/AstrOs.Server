...
## Status screen
10. Status screen shows the droid image with dome/core/body coloring that matches the desktop Status view, plus a legend (Dome/Core/Body + Online/Needs sync/Firmware/Offline) and a **Logout** button.
