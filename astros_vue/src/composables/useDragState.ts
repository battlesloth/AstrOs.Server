...
export function useDragState() {
  ...
  const isDraggingTimeline = computed({
    ...
    set: (val) => {
      dragState.value.isDragging = val;
    },
  });
  ...
  const dragStartWorldX = computed({
    ...
    set: (val) => {
      dragState.value.startWorldX = val;
    },
  });
  ...
  const dragStartWorldY = computed({
    ...
    set: (val) => {
      dragState.value.startWorldY = val;
    },
  });
  ...
  const hasDragged = computed({
    ...
    set: (val) => {
      dragState.value.hasDragged = val;
    },
  });
