  ...
  <div class="w-full space-y-2">
    ...
    >
      <div
        ...
        class="collapse-title flex items-center justify-between pr-12 cursor-pointer bg-primary text-white"
    ...
    >
      <div
        ...
        class="collapse-title cursor-pointer bg-primary text-white"
