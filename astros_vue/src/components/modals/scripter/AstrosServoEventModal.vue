    ...
    <div class="modal-box max-w-md">
      ...
      <div class="space-y-4">
        ...
        <div>
          ...
          <input id="position" v-model.number="position" type="number" min="-1" max="100" placeholder="Position"
            class="input input-bordered w-full" @change="validatePosition" />
        </div>
        ...
        <div>
          ...
          <input id="speed" v-model.number="speed" type="number" min="0" max="255" placeholder="Speed"
            class="input input-bordered w-full" @change="validateSpeed" />
        </div>

        <div>
          <label for="acceleration" class="label">
            <span class="label-text">Accel. (0 to 255, 0 is unlimited)</span>
          </label>
          <input id="acceleration" v-model.number="acceleration" type="number" min="0" max="255"
            placeholder="Acceleration" class="input input-bordered w-full" @change="validateAcceleration" />
        </div>
