...
import { AstrosFieldUsername, AstrosFieldPassword, } from '@/components/index'
...
<template>
    <div class="relative w-full h-screen bg-gray-200 flex items-center justify-center">
        <img v-if="props.background" :src="props.background" alt="Background Image"
            class="absolute inset-0 w-full h-full object-cover opacity-50" />
        <img v-else src="@/assets/images/r2d2-schematic.jpg" alt="Default Background"
            class="absolute inset-0 w-full h-full object-cover opacity-50" />
        ...
        <div class="absolute inset-0 backdrop-blur-sm flex items-center justify-center">
            <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
                <div class="flex flex-col items-center justify-center">
                    ...
                    <AstrosFieldPassword class="w-full mb-4" v-model="credentials.password" @enter="$emit('login')" />
