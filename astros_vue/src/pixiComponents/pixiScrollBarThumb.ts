...
export class PixiScrollBarThumb extends Graphics {
  ...
  constructor(
    ...
    this.rect(0, 0, this.thumbWidth, this.thumbHeight).fill(this.thumbFillColor);
    ...
    this.on('pointerover', () => {
      ...
      this.clear().rect(0, 0, this.thumbWidth, this.thumbHeight).fill(this.thumbFocusColor);
      this.x = currentX;
      this.y = currentY;
    });
    ...
    this.on('pointerout', () => {
      const currentX = this.x;
      const currentY = this.y;
      this.clear().rect(0, 0, this.thumbWidth, this.thumbHeight).fill(this.thumbFillColor);
      this.x = currentX;
      this.y = currentY;
    });
