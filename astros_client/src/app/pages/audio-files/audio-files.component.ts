...
export class AudioFilesComponent implements OnInit {
  ...
  removeFile(id: string) {
    ...
    modalResources.set(ConfirmModalResources.message, `Are you sure you want to delete ${fileName}?`);
    modalResources.set(ConfirmModalResources.confirmEvent, { id: 'audiofile_delete', val: id });
